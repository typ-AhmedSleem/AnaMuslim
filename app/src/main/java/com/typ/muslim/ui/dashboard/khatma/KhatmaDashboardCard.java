...
public class KhatmaDashboardCard extends DashboardCard implements KhatmaManagerCallback {
    ...
    @Override
    public void onManageKhatma(@NonNull Khatma khatma) {

    }

    @Override
    public void onProgressUpdated(@NonNull KhatmaWerd nextWerd) {

    }

    @Override
    public void onSwitchKhatma(@NonNull Khatma khatma) {

    }

    @Override
    public void onFinishKhatma() {
