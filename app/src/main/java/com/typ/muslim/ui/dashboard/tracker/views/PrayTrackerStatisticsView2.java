...
public class PrayTrackerStatisticsView2 extends ViewContainer {
    ...
    public void refreshUI() {
        ...
        for (PrayTrackerRecord record : records) spwTracker.updateStep(record.getPray().ordinalWithoutSunrise(), record.wasPrayed(), record.wasPrayed() ? R.color.green : R.color.red);
