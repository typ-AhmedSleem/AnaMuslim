...
public class StagesView extends ViewFlipper {
    ...
    public void executeAsync(OnTestCompletedListener callback) {
        // TODO: 6/1/2021 Needs a lot of work to be completed
        new Thread(() -> {
            if (stages == null) {
                if (callback != null)
                ...
                stages.iterate(((index, stage) -> {
                    ...
                    if (stage != null && stage.second != null) {
                        ...
                        AManager.log(TAG, "Either stage is null or the executable is null. STAGE[%s] EXECUTABLE[%s]", stage, stage != null ? stage.second : null);
