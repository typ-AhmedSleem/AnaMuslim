...
public class SelectPrayConfigFragment extends Fragment {
    ...
    // Config params
    private int calcMethod = CalculationMethod.EGYPT.ordinal();
    private int asrMethod = AsrMethod.SHAFII.ordinal();
    private int hlMethod = HigherLatitudesMethod.NONE.ordinal();
