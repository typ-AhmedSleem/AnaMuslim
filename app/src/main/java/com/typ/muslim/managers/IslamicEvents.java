...
import static com.typ.muslim.core.ummelqura.UmmalquraCalendar.RABI_AWWAL;
...
public class IslamicEvents {
    ...
    public static List<IslamicEvent> getEventsInYear(int year, boolean isHijriYear) {
        ...
        return Arrays.asList(
                ...
                new IslamicEvent(R.string.birth_of_prophet_mohamed, R.string.birth_of_prophet_mohamed, new HijriDate(hijriYear, RABI_AWWAL, 11), R.color.cardBackground3),
    ...
    public static IslamicEvent searchForEventInMonth(List<IslamicEvent> events, EasyListLooper<IslamicEvent> condition) {
        if (events == null || events.isEmpty())
            events = getEventsThisYear(); // fixme: check this line again
//		for ()
        return null;
    }
