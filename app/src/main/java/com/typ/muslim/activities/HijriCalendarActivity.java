...
import com.typ.muslim.ui.SquarePrayView;
import com.typ.muslim.ui.TrackerPrayRecordView;
import com.typ.muslim.ui.calendar.IslamicEventView;
import com.typ.muslim.ui.calendar.SelectedDateViewCard;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class HijriCalendarActivity extends AppCompatActivity implements CalendarView.OnCalendarSelectListener,
	...
	private Calendar buildScheme(IslamicEvent event) {
		...
		cal.setSchemeColor(AMRes.getColor(this, event.getColorResId()));
