...
public class PrayTimeCore {
	...
	private PrayTimeCore(Context context, Location currentLocation) {
		...
		prayerNames.add(AMRes.getString(context, R.string.fajr));
		prayerNames.add(AMRes.getString(context, R.string.sunrise));
		prayerNames.add(DateUtils.isTodayFriday() ? AMRes.getString(context, R.string.jumaa) :AMRes.getString(context, R.string.dhuhr));
		prayerNames.add(AMRes.getString(context, R.string.asr));
		//prayerNames.add(AMRes.getString(context, R.string.sunset));
		prayerNames.add(AMRes.getString(context, R.string.maghrib));
		prayerNames.add(AMRes.getString(context, R.string.isha));
