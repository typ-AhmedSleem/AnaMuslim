...
public class UmmalquraCalendar extends GregorianCalendar {
    ...
    public void set(int field, int value) {
        if (field == YEAR || field == MONTH || field == DAY_OF_MONTH) {
            int[] hDateInfo = UmmalquraGregorianConverter.toHijri(new Timestamp(getTime()));
            if (field == YEAR) {
                hDateInfo[0] = value;
            } else if (field == MONTH) {
                hDateInfo[1] = value;
    ...
    /**
     * Returns the length of the month represented by this calendar. <p> This returns the length of
     * the month in days.
     *
     * @return the length of the month in days
     */
    ...
    /**
     * Returns the length of the year represented by this calendar. <p> This returns the length of
     ...
     * calendar <code>field</code>. <p>For example, if this <code>Calendar</code>'s date is
    ...
    /**
     * Returns a <code>Map</code> containing all names of the calendar <code>field</code> in the
     ...
     * example, if this <code>Calendar</code> is a lunisolar calendar system and the year value
