            ...
            public void onClick(View v, float x, float y) {
                ...
                animator.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationStart(Animator animation) {
                        super.onAnimationStart(animation);
                        // Change Application Theme
                        view.setBackgroundColor(AMRes.getColor(requireContext(), R.color.colorAccent));
                        v.setBackgroundColor(AMRes.getColor(requireContext(), R.color.colorPrimary));
                        view.findViewById(R.id.btn_theme_dark).setBackgroundColor(AMRes.getColor(requireContext(), R.color.colorText));
                        view.findViewById(R.id.btn_theme_red).setBackgroundColor(AMRes.getColor(requireContext(), R.color.colorText));
                        view.findViewById(R.id.btn_theme_teal).setBackgroundColor(AMRes.getColor(requireContext(), R.color.colorText));
                        view.findViewById(R.id.btn_theme_blue).setBackgroundColor(AMRes.getColor(requireContext(), R.color.colorText));
                    }
